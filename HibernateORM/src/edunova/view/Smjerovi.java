...
public class Smjerovi extends javax.swing.JFrame {
    ...
    private void ucitajSmjerove() {
        ...
        for(Smjer s : obradaSmjer.getLista()){
            m.addElement(s);
        }
        lstSmjerovi.setModel(m);
        
        if(m.getSize()>0){
            lstSmjerovi.setSelectedIndex(m.getSize()-1);
        }
    ...
    private void preuzmiVrijednosti(Smjer s) {
